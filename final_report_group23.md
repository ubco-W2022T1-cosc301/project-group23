...
![Gender v Traits Bar Plot](./images/barplot.png)
And the final question about differences in race and personality traits leads to graphs like this one.
![Race v Traits Correlation Plot](./images/Race%20Correlation.png)
<br>
<br>
<br>
...
![Line Plot by Age](./images/AgeLine.png)
...
![Box Plot by Age](./images/AgeBox.png)
...
## **Hypothesis**: Based on extant research, on average, females will show higher scores than men on Extraversion, and Agreeableness, lower scores on Neuroticism, and there will be no significant gender differences for Conscientiousness or Openness.
<br>
